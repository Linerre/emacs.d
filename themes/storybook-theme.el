...
(let ((fg "#442c09")
      ...
      (gnu-nav "#ddddff")
      (gnu-block "#f2efe4")
      (gnu-block-border "#d4cbb6")
      (emacs-cn-banner "#d1f0ff"))
  (custom-theme-set-faces
   ...
   `(hl-line                        ((((type graphic)) :background ,gnu-block)
                                     (((type tty)) :background "#ffffff")))
   ...
   `(meow-keypad-cursor             ((t (:background ,gnu-block-border))))
   `(meow-insert-cursor             ((t (:background ,gnu-block-border))))
   `(meow-normal-cursor             ((t (:background ,gnu-block-border))))
   `(meow-motion-cursor             ((t (:background ,gnu-block-border))))
   ...
   `(mode-line                      ((((type tty))
                                      (:background "grey70"))
                                     (((type graphic))
                                      (:box (t) :background ,bg-2))))
   `(mode-line-inactive             ((((type tty))
                                      (:background "grey80"))
                                     (((type graphic))
                                      (:box (t) :background ,bg-1))))
   `(parenthesis                    ((t ())))
